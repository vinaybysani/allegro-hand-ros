...
double k_p[DOF_JOINTS] =
        {
                ...
                600.0, 600.0, 600.0,
                1000.0,  // These gains are loaded if the 'gains_pd.yaml' file is not loaded
...
double k_d[DOF_JOINTS] =
        {
                ...
                15.0, 20.0, 15.0,
                15.0,  // These gains are loaded if the 'gains_pd.yaml' file is not loaded
                15.0, 20.0, 15.0, 15.0,
                30.0, 20.0, 20.0, 15.0
        };
...
std::string initialPosition[DOF_JOINTS] =
        {
                "~initial_position/j00", "~initial_position/j01", "~initial_position/j02",
                "~initial_position/j03",
                "~initial_position/j10", "~initial_position/j11", "~initial_position/j12",
                "~initial_position/j13",
                "~initial_position/j20", "~initial_position/j21", "~initial_position/j22",
                "~initial_position/j23",
                "~initial_position/j30", "~initial_position/j31", "~initial_position/j32",
